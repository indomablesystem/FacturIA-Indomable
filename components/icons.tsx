...
export const UploadIcon: React.FC<IconProps> = ({ className = "w-10 h-10 text-gray-400" }) => (
...
export const SpinnerIcon: React.FC<IconProps> = ({ className = "w-8 h-8 text-accent" }) => (
...
export const FileTextIcon: React.FC<IconProps> = ({ className = "w-7 h-7 text-accent" }) => (
...
export const GoogleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C42.022,35.244,44,30.034,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
    </svg>
);
